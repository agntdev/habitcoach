...
export interface Session {
  wizard?: {
    step: "title" | "time" | "timezone";
    title?: string;
    scheduleType?: "daily" | "weekdays" | "times";
    reminderTime?: string;
  };
  /** Harness-only fallback when no durable runtime binding is available. */
  habitReplayData?: import("./habit-core.js").HabitData;
